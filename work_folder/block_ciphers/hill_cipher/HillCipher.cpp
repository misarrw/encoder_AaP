...
std::string HillCipher::hill(std::string& text, std::vector<std::vector<int>>& key, int& option)
{
    std::vector<std::vector<int>> text_ngrammas_numbers = text_into_numbers_ngrammas(text, key);
