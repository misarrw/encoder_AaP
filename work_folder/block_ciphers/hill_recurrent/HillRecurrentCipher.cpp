/**
 * \file
 * \brief Реализация HillRecurrentCipher — рекуррентного блочного шифра Хилла.
 */
...
/**
 * \brief Генерирует новый ключ по рекуррентному правилу как произведение двух предыдущих ключей.
 * \param key1 Первый ключ.
 * \param key2 Второй ключ.
 * \return Новый ключ, полученный перемножением key1 и key2.
 */
std::vector<std::vector<int>> HillRecurrentCipher::generate_next_key(
...
/**
 * \brief Выполняет шифрование или дешифрование текста с использованием рекуррентного блочного шифра Хилла.
 * \param pretext Текст для обработки.
 * \param option '1' — шифрование, '2' — дешифрование.
 * \return Шифртекст или расшифрованный текст.
 */
